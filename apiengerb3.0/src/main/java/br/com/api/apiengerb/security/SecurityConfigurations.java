...
public class SecurityConfigurations {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        return httpSecurity
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers(HttpMethod.GET, "/documentos/listar/{userId}").permitAll()
                        .requestMatchers(HttpMethod.POST, "/auth/dadosUser").hasRole("USER")
                        .requestMatchers(HttpMethod.GET, "/cliente/carregar/{idUser}").hasRole("USER")
                        .requestMatchers(HttpMethod.PUT, "/cliente/alterar/{idUser}").hasRole("USER")
                        .requestMatchers(HttpMethod.PUT, "/cliente/alterarsenha/{idUser}").hasRole("USER")
                        .requestMatchers(HttpMethod.PUT, "/cliente/updateUser/{idUser}").hasRole("EMP")
                        .requestMatchers(HttpMethod.POST, "/auth/cadastrar").hasRole("EMP")
                        .requestMatchers(HttpMethod.POST, "/documentos/cadastrar").hasRole("EMP")
                        .requestMatchers(HttpMethod.POST, "/auth/cadastraremp").hasRole("EMP")
                        .requestMatchers(HttpMethod.GET, "/empresa/carregar/{idUser}").hasRole("EMP")
                        ...
                        .requestMatchers(HttpMethod.PUT, "/empresa/alterar/{idUser}").hasRole("EMP")
                        .requestMatchers(HttpMethod.DELETE, "/cliente/remover/{idCliente}").hasRole("EMP")
                        .requestMatchers(HttpMethod.DELETE, "/documentos/remover/{idDocumento}").hasRole("EMP")
    ...
    public FilterRegistrationBean<CorsFilter> corsFilter() {
        ...
        config.addAllowedOrigin("https://compreagua.com.br"); // Domínio do seu frontend
