...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler implements AuthenticationFailureHandler {
    ...
    public ResponseEntity<Object> handleConstraintViolationException(
        ...
        // Extrair as mensagens de erro das violações de validação
        // Extrair as mensagens de erro das violações de validação
        ...
        // Se houver mensagens de erro, use a primeira como mensagem principal
        String mainMessage = !errorMessages.isEmpty() ? errorMessages.get(0) : "Erro de validação";

        // Construir a resposta de erro
        ErrorResponse errorResponse = new ErrorResponse(HttpStatus.UNPROCESSABLE_ENTITY.value(), mainMessage);
